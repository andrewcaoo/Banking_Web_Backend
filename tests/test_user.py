...
#         "/api/v1/base_account",
#         json={"username": test_username, "email": test_email, "password": test_password, "employee_id": None, "cus_account_id": None, "profile_image_url": None, "is_ban": False, "permission": 0},
#     )
...
def test_get_acc(client: TestClient) -> None:
    response = client.get(f"/api/v1/base_account/{"userson"}")
    assert response.status_code == 200
